...
import kr.co.hanbit.firebasechat.databinding.ActivityMainBinding
import kr.co.hanbit.firebasechat.model.User

class MainActivity : AppCompatActivity() {

    val binding by lazy{ ActivityMainBinding.inflate(layoutInflater)}
    val database = Firebase.database("https://sujinl-default-rtdb.asia-southeast1.firebasedatabase.app/")
